...
class Constellation	{
	...
	resize(){
		if(this.responsive){
			...
			this.numberOfStars = this.starDensity;
			this.fill();
		}
	}
	draw(){
...
var constellationPresets = [
  {
  name : "standard",
  properties: [5,2,0,0,0,250,0.5,0.1,100,0,0,2,0,0,0,true]
  },
  {
  name : "test",
  properties: [250,075,75,05],
  map: [[10,10],[35,35],[35,70]]
  },
  {
  name : "aquarius",
  properties: [319,054,054,05]
  },
  {
  name : "pisces",
  properties: [314,048,084,05]
  },
  {
  name : "aries",
  properties: [000,089,078,05]
  },
  {
  name : "taurus",
  properties: [022,085,083,05]
  },
  {
  name : "gemini",
  properties: [029,092,093,05]
  },
  {
  name : "cancer",
  properties: [054,099,092,05]
  },
  {
  name : "leo",
  properties: [063,093,095,05]
  },
  {
  name : "virgo",
  properties: [072,088,082,05]
  },
  {
  name : "libra",
  properties: [112,085,056,05]
  },
  {
  name : "scorpio",
  properties: [161,086,065,05]
  },
  {
  name : "sagittarius",
  properties: [238,060,063,05]
  },
  {
  name : "capricorn",
  properties: [267,065,073,05]
  },
